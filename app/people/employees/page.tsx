...
import { Plus, Search, Users, Mail, Trash2, Edit } from 'lucide-react'
...
function EmployeesPageContent({ initialEmployees }: EmployeesPageProps) {
...
export default async function EmployeesPage() {
  const { requireOrganization } = await import('@/domains/core/auth')
  const { getEmployees } = await import('@/domains/people/employees')
